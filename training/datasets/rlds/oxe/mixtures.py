...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "omniaction": [
        ("bridge_events", 1.0),
        ("bridge_sentiment", 1.0),
        ("bridge_overlap", 1.0),
        ("bridge_identity", 1.0),
        ("bridge_three", 1.0),
        ("bridge_two", 1.0),
        ("fractal_events", 1.0),
        ("fractal_sentiment", 1.0),
        ("fractal_overlap", 1.0),
        ("fractal_identity", 1.0),
        ("fractal_three", 1.0),
        ("fractal_two", 1.0),
        ("jaco_play_events", 1.0),
        ("jaco_play_sentiment", 1.0),
        ("jaco_play_overlap", 1.0),
        ("jaco_play_identity", 1.0),
        ("jaco_play_three", 1.0),
        ("jaco_play_two", 1.0),
        ("ucsd_kitchen_events", 1.0),
        ("ucsd_kitchen_sentiment", 1.0),
        ("ucsd_kitchen_overlap", 1.0),
        ("ucsd_kitchen_identity", 1.0),
        ("ucsd_kitchen_three", 1.0),
        ("ucsd_kitchen_two", 1.0),
        ("bridge_one", 1.0),
    ],
    # === Bridge V2 Dataset ===
    "bridge": [
    ...
    "omniaction_libero_spatial": [
        ("libero_speech_spatial_events", 1.0),
        ("libero_speech_spatial_sentiment", 1.0),
        ("libero_speech_spatial_overlap", 1.0),
        ("libero_speech_spatial_identity", 1.0),
        ("libero_speech_spatial_three", 1.0),
        ("libero_speech_spatial_two", 1.0),
    ],
    "omniaction_libero_goal": [
        ("libero_speech_goal_events", 1.0),
        ("libero_speech_goal_sentiment", 1.0),
        ("libero_speech_goal_overlap", 1.0),
        ("libero_speech_goal_identity", 1.0),
        ("libero_speech_goal_three", 1.0),
        ("libero_speech_goal_two", 1.0),
    ],
    "omniaction_libero_object": [
        ("libero_speech_object_events", 1.0),
        ("libero_speech_object_sentiment", 1.0),
        ("libero_speech_object_overlap", 1.0),
        ("libero_speech_object_identity", 1.0),
        ("libero_speech_object_three", 1.0),
        ("libero_speech_object_two", 1.0),
    ],
    "omniaction_libero10": [
        ("libero_speech10_events", 1.0),
        ("libero_speech10_sentiment", 1.0),
        ("libero_speech10_overlap", 1.0),
        ("libero_speech10_identity", 1.0),
        ("libero_speech10_three", 1.0),
        ("libero_speech10_two", 1.0),
    ],
